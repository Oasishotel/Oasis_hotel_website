...
const OurRooms = () => {
  ...
  return (
    <section className="bg-[#F8F1E5] py-20 px-[5%] min-h-screen flex flex-col md:flex-row">

      <div className="md:w-1/3 md:sticky md:top-0 p-6">
        <h2 className="font-['Playfair_Display',_serif] text-[42px] text-[#0c0c0c] mb-2 leading-tight tracking-wide">
          Our Rooms
        </h2>
        <h3 className="font-['Playfair_Display',_serif] text-[32px] italic text-[#D4A373] mb-4">
          Great Comfort
        </h3>
        <p className="font-['Open_Sans',_sans-serif] text-[18px] text-[#555] leading-relaxed max-w-lg">
      ...
      <div className="md:w-2/3 p-6">
        <div className="space-y-12">
          {rooms.map((room, index) => (
            <div
              key={index}
              className="bg-white shadow-lg rounded-lg p-6 transform transition-all duration-500 hover:shadow-xl hover:-translate-y-1"
            >
              ...
              <div className="mt-6">
                <h4 className="font-['Playfair_Display',_serif] text-[24px] text-[#D4A373] text-center mb-2">
                  {room.name}
                </h4>
                <p className="font-['Open_Sans',_sans-serif] text-[16px] text-[#555] text-center leading-relaxed mb-4">
                  {room.description}
                </p>
                <div className="text-center">
                  <a
                    href="https://direct-book.com/properties/OasisHotel"
                    className="inline-block py-2 px-6 bg-[#D4A373] text-[#0c0c0c] font-['Open_Sans',_sans-serif] text-sm font-bold uppercase tracking-wider no-underline rounded-md transition-all duration-300 hover:bg-[#c18d5d] hover:shadow-md transform hover:-translate-y-1"
                  >
                    Book Room
                  </a>
                </div>
